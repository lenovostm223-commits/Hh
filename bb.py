...
║  Fully fixed · Environment variables · No hardcoded keys                    ║
...
📌 ENVIRONMENT VARIABLES (Replit Secrets):
   ...
   GOFILE_TOKEN     = (optional) your Gofile account token
"""
...
GOFILE_API_TOKEN = os.environ.get('GOFILE_TOKEN', '')
...
class MegaDownloader:
    ...
    def download(self, url: str, session_id: str = None) -> Tuple[bool, List[Path], str]:
        ...
        try:
            ...
            downloaded = [p for p in session_dir.rglob('*') if p.is_file()]
            if downloaded:
